<template>
  <div class="plugin">
    <el-row class="plugin-header">
      ...
      <el-col :span="18">
        <el-row class="plugin-summary">
          <h1>{{ plugin.name }}</h1>
          <el-tag class="plugin-installed-version">v{{ plugin.installedVersion }}</el-tag>
        </el-row>
        <el-row>
          <span class="plugin-author">by {{ plugin.author }}</span>
        </el-row>
        <el-row class="plugin-actions">
          <el-button @click="openInBrowser(plugin.releaseNotesUrl)">Release Notes</el-button>
          <el-button :type="danger">Uninstall</el-button>
        </el-row>
      </el-col>
    </el-row>
    ...
    <el-row class="plugin-details">
      <div class="plugin-links">
        <a class="social-icon" :href="plugin.repositoryUrl" target="_blank">
